...
<head>
    ...
    <title>الصفحة غير موجودة - {{ setting('site_name', config('app.name')) }}</title>
...
<body class="flex h-full min-h-screen flex-col items-center justify-center bg-paper px-6 font-sans text-ink antialiased">
    <div class="w-full max-w-sm text-center">
        <p class="font-display text-7xl font-bold text-brass">404</p>
        <h1 class="mt-4 font-display text-2xl font-semibold text-ink">الصفحة غير موجودة</h1>
