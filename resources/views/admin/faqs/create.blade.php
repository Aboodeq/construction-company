<x-admin.layouts.app title="إضافة سؤال">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة سؤال شائع</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.faqs.store') }}"
            ...
            @include('admin.faqs.partials.fields', ['faq' => null])
