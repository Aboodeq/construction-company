<x-admin.layouts.app title="إضافة رأي عميل">
    <div class="mx-auto w-full max-w-3xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة رأي عميل</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-ink-soft">
                أدخل بيانات الرأي أولًا، ثم يمكنك إضافة صورة العميل بعد الحفظ.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.testimonials.store') }}"
            ...
            @include('admin.testimonials.partials.fields', ['testimonial' => null])
