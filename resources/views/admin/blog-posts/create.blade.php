<x-admin.layouts.app title="إضافة مقالة">
    <div class="mx-auto w-full max-w-3xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة مقالة جديدة</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-ink-soft">
                أدخل نص المقالة أولًا، ثم يمكنك إضافة صورة الغلاف وبيانات تحسين محركات البحث بعد الحفظ.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.blog.store') }}"
            ...
            @include('admin.blog-posts.partials.fields', ['post' => null])
