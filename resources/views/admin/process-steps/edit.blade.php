<x-admin.layouts.app title="تعديل خطوة">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            <a href="{{ route('admin.process-steps.index') }}"
                ...
                العودة إلى مراحل العمل
            </a>
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">تعديل مرحلة عمل</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.process-steps.update', $processStep) }}"
            ...
            @include('admin.process-steps.partials.fields', ['processStep' => $processStep])
