<x-admin.layouts.app title="إضافة خطوة">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة مرحلة عمل</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.process-steps.store') }}"
            ...
            @include('admin.process-steps.partials.fields', ['processStep' => null])
