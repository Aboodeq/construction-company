<x-admin.layouts.app title="إضافة شريحة">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة شريحة بانر</h2>
        </div>
        ...
        <form method="POST" action="{{ route('admin.hero-slides.store') }}"
            ...
            @include('admin.hero-slides.partials.fields', ['heroSlide' => null])
