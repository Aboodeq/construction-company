<x-admin.layouts.app title="إضافة عضو فريق">
    <div class="mx-auto w-full max-w-3xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة عضو فريق</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-ink-soft">
                أدخل بياناته أولًا، ثم يمكنك إضافة صورته بعد الحفظ.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.team.store') }}"
            ...
            @include('admin.team.partials.fields', ['member' => null])
