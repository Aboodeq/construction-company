<x-admin.layouts.app title="إضافة مستخدم">
    <div class="mx-auto w-full max-w-2xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة مستخدم جديد</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-ink-soft">
                سيتمكن هذا المستخدم من تسجيل الدخول فورًا بالبريد الإلكتروني وكلمة المرور المحددين.
            </p>
        </div>
