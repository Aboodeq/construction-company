<x-admin.layouts.app title="إضافة مشروع">
    <div class="mx-auto w-full max-w-3xl">
        <div class="mb-8">
            ...
            <h2 class="mt-4 font-display text-2xl font-semibold text-ink">إضافة مشروع جديد</h2>
            <p class="mt-2 max-w-2xl text-sm leading-6 text-ink-soft">
                أدخل بيانات المشروع الأساسية أولًا، ثم يمكنك إضافة الصور والخدمات المرتبطة بعد الحفظ.
            </p>
        </div>
        ...
        <form method="POST" action="{{ route('admin.projects.store') }}"
            ...
            @include('admin.projects.partials.fields', ['project' => null])
